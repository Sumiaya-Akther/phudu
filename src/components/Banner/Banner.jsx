    ...
    return (
        <div className='bg-linear-to-t from-[#fefefe] to-[#f1f1f1] py-18 px-26 border-2 border-r-white  border-t-neutral-content border-b-neutral-content border-l-white rounded-2xl'>
            <div className='text-center space-y-4'>
                ...
                <input className='w-auto md:w-1/3 py-1 px-3 rounded-2xl bg-white border border-gray-300 shadow-md focus:outline-none focus:shadow-outline' type="text" placeholder='Search any doctor...' />
